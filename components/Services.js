...
import { faCogs, faLaptopCode, faPaintBrush } from '@fortawesome/free-solid-svg-icons';
            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-12 col-md-6 col-lg-4">
                        <div className={`${styles.service} ${styles.servicePurple}`}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="69.016" height="64.973"
                            ...
                            <h5 className={styles.serviceTitle}>Web Design</h5>
                            <p className={styles.serviceCaption}>Lipsum as it is sometimes known is dummy text used in laying out
                                print, graphic or web designs.</p>
                            <svg className={styles.serviceWave} width="369.919" viewBox="0 0 369.919 223.59">
                                <path id="Shape"
                                      d="M449,2700.557s15.007-66.794,51.8-54.34,43.02,57.737,121.7,13.585,95.662-58.3,124.531-23.774,71.888-34.53,71.888-34.53v223.59H449Z"
                                      transform="translate(-449 -2601.498)" fill="#803afb"/>
                            </svg>
                        </div>
                    </div>
                    <div className="col-12 col-md-6 col-lg-4">
                        <div className={`${styles.service} ${styles.serviceYellow}`}>
                            <svg  xmlns="http://www.w3.org/2000/svg" width="72.005" height="65"
                            ...
                            <h5 className={styles.serviceTitle}>Interface Design</h5>
                            <p className={styles.serviceCaption}>Lipsum as it is sometimes known is dummy text used in laying out
                                print, graphic or web designs.</p>
                            <svg className={styles.serviceWave} width="369.919" viewBox="0 0 369.919 223.59">
                                <path id="Shape"
                                      d="M449,2700.557s15.007-66.794,51.8-54.34,43.02,57.737,121.7,13.585,95.662-58.3,124.531-23.774,71.888-34.53,71.888-34.53v223.59H449Z"
                                      transform="translate(-449 -2601.498)" fill="#FFBB01"/>
                            </svg>
                        </div>
                    </div>
                    <div className="col-12 col-md-6 col-lg-4">
                        <div className={`${styles.service} ${styles.servicePink}`}>
                            <svg  xmlns="http://www.w3.org/2000/svg" width="78.997" height="65"
                            ...
                            <h5 className={styles.serviceTitle}>Web Development</h5>
                            <p className={styles.serviceCaption}>Lipsum as it is sometimes known is dummy text used in laying out
                                print, graphic or web designs.</p>
                            <svg className={styles.serviceWave} width="369.919" viewBox="0 0 369.919 223.59">
                                <path id="Shape"
                                      d="M449,2700.557s15.007-66.794,51.8-54.34,43.02,57.737,121.7,13.585,95.662-58.3,124.531-23.774,71.888-34.53,71.888-34.53v223.59H449Z"
                                      transform="translate(-449 -2601.498)" fill="#F5276C"/>
                            </svg>
                        </div>
                    </div>
                    <div className="col-12 col-md-6 col-lg-4">
                        <div className={`${styles.service} ${styles.serviceOrange}`}>
                            <svg  xmlns="http://www.w3.org/2000/svg" width="72.977" height="64.991"
                            ...
                            <h5 className={styles.serviceTitle}>UX Design</h5>
                            <p className={styles.serviceCaption}>Lipsum as it is sometimes known is dummy text used in laying out
                                print, graphic or web designs.</p>
                            <svg className={styles.serviceWave} width="369.919" viewBox="0 0 369.919 223.59">
                                <path id="Shape"
                                      d="M449,2700.557s15.007-66.794,51.8-54.34,43.02,57.737,121.7,13.585,95.662-58.3,124.531-23.774,71.888-34.53,71.888-34.53v223.59H449Z"
                                      transform="translate(-449 -2601.498)" fill="#FF5823"/>
                            </svg>
                        </div>
                    </div>
                    <div className="col-12 col-md-6 col-lg-4">
                        <div className={`${styles.service} ${styles.serviceBlue}`}>
                            <svg  xmlns="http://www.w3.org/2000/svg" width="64.99" height="64.99"
                            ...
                            <h5 className={styles.serviceTitle}>Motion Graphic</h5>
                            <p className={styles.serviceCaption}>Lipsum as it is sometimes known is dummy text used in laying out
                                print, graphic or web designs.</p>
                            <svg className={styles.serviceWave} width="369.919" viewBox="0 0 369.919 223.59">
                                <path id="Shape"
                                      d="M449,2700.557s15.007-66.794,51.8-54.34,43.02,57.737,121.7,13.585,95.662-58.3,124.531-23.774,71.888-34.53,71.888-34.53v223.59H449Z"
                                      transform="translate(-449 -2601.498)" fill="#03ACF8"/>
                            </svg>
                        </div>
                    </div>
                    <div className="col-12 col-md-6 col-lg-4">
                        <div className={`${styles.service} ${styles.serviceGreen}`}>
                            ...
                            <h5 className={styles.serviceTitle}>SEO Optimize</h5>
                            <p className={styles.serviceCaption}>Lipsum as it is sometimes known is dummy text used in laying out
                                print, graphic or web designs.</p>
                            <svg className={styles.serviceWave} width="369.919" viewBox="0 0 369.919 223.59">
                                <path id="Shape"
                                      d="M449,2700.557s15.007-66.794,51.8-54.34,43.02,57.737,121.7,13.585,95.662-58.3,124.531-23.774,71.888-34.53,71.888-34.53v223.59H449Z"
                                      transform="translate(-449 -2601.498)" fill="#49B846"/>
                            </svg>
                        </div>
                    </div>
                </div>
